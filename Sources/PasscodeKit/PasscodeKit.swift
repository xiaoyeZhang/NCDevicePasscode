...
extension PasscodeKit {
    ...
    public class func showPasscode() -> Bool {
        if let value = try? UserDefaults.standard.bool(forKey: "showPasscode") {
            return value
        }
        return true
    }
    
    public class func showPasscode(_ showPasscode: Bool) {
        UserDefaults.standard.set(showPasscode, forKey: "showPasscode")
    }
